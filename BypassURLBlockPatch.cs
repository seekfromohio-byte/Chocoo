...
public static class BypassURLBlockPatch
{
  public static bool Prefix(ChatController __instance)
  {
    if (!ChocooPlugin.BypassURLBlockEnabled)
      return true;
    PlayerControl.LocalPlayer.RpcSendChat(__instance.freeChatField.Text);
    return false;
  }
}
